...
public static class RegisterMqListenerExtension
{
    ...
    public static IServiceCollection StockSharpRegisterMqListeners(this IServiceCollection services)
    {
        return services
            ...
            .RegisterMqListener<UsersReadTelegramReceive, int[]?, List<UserTelegramModelDB>>()
            ...
            .RegisterMqListener<GetBoardsStockSharpDriverReceive, int[], TResponseModel<List<BoardStockSharpMetaModel>>>()
            .RegisterMqListener<FindBoardsStockSharpDriverReceive, BoardStockSharpModel, TResponseModel<List<BoardStockSharpMetaModel>>>()
